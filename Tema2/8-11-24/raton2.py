...
# Variable to track the last detected gesture
last_gesture = "none"
...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Gesture Detection
            current_gesture = "none"  # Default gesture
            ...
            if (index_tip.y < middle_tip.y and index_tip.y < ring_tip.y and 
                ...
                current_gesture = "mouse_move"

            # Fist gesture - Trigger left click
            elif (index_tip.y > index_mcp.y and middle_tip.y > index_mcp.y and
                  ring_tip.y > index_mcp.y and pinky_tip.y > index_mcp.y):
                current_time = time.time()
                if current_gesture != last_gesture and current_time - last_click_time > click_debounce_time:
                    pyautogui.click()
                    last_click_time = current_time
                current_gesture = "left_click"

            # Thumb tip is the highest - Trigger right click
            ...
            # Update last gesture if the gesture changes
